...
## motivo beneficio 5 = programa de becas 
...
#print(colaboradores_2)
#colaboradores_2.to_csv("colaboradores_2.csv", index = False)
...
colaboradores_df = colaboradores_df.drop_duplicates(colaboradores_df.columns[colaboradores_df.columns.isin(['id_db__c'])],
                            keep='first')
#colaboradores_df.to_csv("colaboradores.csv", index = False)  ##2831 
...
colaboradores_df = colaboradores_df.drop_duplicates(colaboradores_df.columns[colaboradores_df.columns.isin(['id_db__c'])],
                              keep='last')
print(colaboradores_df)
#colaboradores_df.to_csv('colaboradores_totales.csv', index = False) 
...
# colaboradores_df.to_csv('colaboradores_migrados.csv', index = False)
...
# # colaboradores_prueba = colaboradores_df.iloc[8:382]
# # print(colaboradores_prueba)


# colaborador = colaboradores_df.to_dict('records')


# # print(colaborador)

# resultado = sf.bulk.Contact.insert(colaborador) 


# #query2 = 'SELECT Id, Birthdate, ParentId FROM Contact'
# #sf_cuentas = sf.bulk.Contact.query(query2)
# #sf_cuentas = pd.DataFrame(sf_cuentas)
